...
exports.AppModule = AppModule = tslib_1.__decorate([
    (0, common_1.Module)({
        ...
        providers: [app_service_1.AppService, jwt_stratergy_1.JwtStrategy],
        exports: [jwt_stratergy_1.JwtStrategy],
    })
], AppModule);
...
const { warnEnvConflicts } = __webpack_require__(13);
warnEnvConflicts({
...
var as = ue((Ng, ss) => {
    "use strict";
    var Fc = __webpack_require__(14), os = __webpack_require__(15), de = hi(), { env: G } = process, Qe;
...
var As = ue((Bh, _e) => {
    "use strict";
    var Fi = __webpack_require__(16), Mi = __webpack_require__(17), np = __webpack_require__(14), ip = __webpack_require__(18), op = vs(), Ts = op.version, sp = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
    function ap(e) {
        let r = {}, t = e.toString();
        t = t.replace(/\r\n?/mg, `
`);
...
var gr = N;
var Go = O(__webpack_require__(16));
...
var Ko = O(__webpack_require__(19)), mi = O(__webpack_require__(20)), Ht = O(__webpack_require__(14));
...
var Zt = O(__webpack_require__(22), 1);
...
var Wc = O(on());
var M = O(__webpack_require__(17)), Jc = O(on()), wh = N("prisma:engines");
...
var Si = O(__webpack_require__(16)), fs = gr("chmodPlusX");
...
var Xs = O(Di());
var Zs = O(__webpack_require__(16));
...
var cu = O(Ti());
var pu = __webpack_require__(23), du = __webpack_require__(24), mu = O(__webpack_require__(16)), ri = O(__webpack_require__(17));
var ie = class e {
...
var dl = O(__webpack_require__(16)), St = O(__webpack_require__(17));
function Qn(e) {
...
function Ol(e) { if (e?.kind === "itx")
    return e.options.id; }
var wo = O(__webpack_require__(14)), kl = O(__webpack_require__(17));
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_b = typeof authenticated_request_1.AuthenticatedRequest !== "undefined" && authenticated_request_1.AuthenticatedRequest) === "function" ? _b : Object]),
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, common_1.Req)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_d = typeof authenticated_request_1.AuthenticatedRequest !== "undefined" && authenticated_request_1.AuthenticatedRequest) === "function" ? _d : Object]),
...
tslib_1.__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(shared_prisma_types_1.Role.ADMIN),
    tslib_1.__param(0, (0, common_1.Body)()),
    tslib_1.__param(1, (0, common_1.Param)('id')),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_g = typeof shared_prisma_types_1.AdminUpdatable !== "undefined" && shared_prisma_types_1.AdminUpdatable) === "function" ? _g : Object, String]),
...
let AuthService = class AuthService {
    ...
    async login(email, password) {
        ...
        if (!isValid)
            return null;
        // Create a signed JWT
        const token = jwt.sign({ sub: user.id, role: user.role }, this.configService.get('JWT_SECRET'), { expiresIn: '1d' });
        return token;
    }
};
    ...
    constructor(configService) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromExtractors([
                (req) => req.cookies?.auth_token, // read token from cookie
            ]),
